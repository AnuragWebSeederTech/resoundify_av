...
const HeroSection = () => {
  return (
    <div className="min-h-[95vh] relative flex items-center  font-sans overflow-hidden">
      ...
      {/* Content Container */}
      <div className="relative z-10 max-w-7xl items-start mx-auto px-6 py-20 w-full">
        {/* Main Heading */}
        ...
        {/* Subtitle */}
        <p className="text-lg md:text-2xl text-white max-w-7xl mx-auto mb-12 leading-relaxed font-light animate-fade-in-up" style={{animationDelay: '0.4s'}}>
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center items-center animate-fade-in-up" style={{animationDelay: '0.6s'}}>
          <button className="group px-8 py-4 bg-transparent border-2 border-blue-400 text-white rounded-lg font-semibold text-xl hover:bg-blue-200 hover:text-blue-900 transition-all duration-300 flex items-center gap-3 min-w-[200px] backdrop-blur-sm">
