    ...
    <header className="w-full absolute top-0 left-0 right-0 bg-transparent z-50">
      ...
      <div className="text-gray-700 bg-white text-base px-6 lg:px-10 py-1 flex justify-end items-center border-b border-gray-200">
        <div className="flex items-center space-x-6 font-medium tracking-wide">
          ...
          <div className="flex items-center space-x-2 hover:text-blue-700 transition duration-300 cursor-pointer">
            <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="lucide lucide-phone">
          ...
          <a href="https://linkedin.com" target="_blank" rel="noopener noreferrer" className="hover:text-blue-700 transition duration-300">
            <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="lucide lucide-linkedin">
      ...
      {/* Main nav */}
      <div className="flex bg-white justify-between items-center px-6 lg:px-10 py-2 mx-auto shadow-md relative">
        <div className="flex items-center space-x-4">
          <img src="/images/resoundifyLogo.jpeg" alt="Resoundify Logo" className="h-12 w-auto object-cover rounded-lg" />
        </div>
        ...
        {/* Search Bar */}
        {isSearchOpen && (
          <form onSubmit={handleSearchSubmit} className="absolute top-1/2 right-16 transform -translate-y-1/2 flex items-center bg-white border border-gray-300 rounded-full px-4 py-2 shadow-lg transition-all duration-300 ease-in-out w-96">
            <input
              type="text"
              placeholder="Search..."
