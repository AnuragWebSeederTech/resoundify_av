...
const Header = () => {
  ...
  return (
    <header className="w-full absolute top-0 left-0 right-0 bg-transparent z-50">
      {/* Top bar */}
      <div className="text-black bg-white text-base px-6 lg:px-5 py-1 pt-2 flex justify-between items-center">
      ...
      {/* Main nav */}
      <div className="flex bg-transparent justify-center items-center mt-5 px-6 lg:px-10 py-1 mx-auto relative">
        {/* <div className="flex block items-center space-x-4">
          <img src="/images/resoundifyLogo1.png" alt="Resoundify Logo" className="h-14 w-auto object-cover rounded-lg" />
        </div> */}
        <div></div>

        <nav className="flex items-center space-x-20 font-medium text-xl text-black hidden md:flex">
          ...
          {/* Search Icon */}
          {/* <div className="cursor-pointer hover:text-white transition duration-300 ml-6" onClick={handleSearchToggle}>
