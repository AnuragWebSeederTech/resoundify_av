...
const Header = () => {
  return (
    <header className="w-full shadow-xl bg-white z-50 sticky top-0"> {/* Enhanced shadow for better appeal */}
      ...
      <div className="bg-gray-100 text-gray-800 text-base px-6 lg:px-16 py-3 flex justify-between items-center border-b border-gray-200"> {/* Darker text and subtle bottom border */}
        <div></div>
      ...
      {/* Main Navigation */}
      <div className="bg-white flex justify-between items-center px-6 lg:px-16 py-4 mx-auto">
        {/* Logo */}
        ...
        <nav className="space-x-12 font-semibold text-lg text-gray-900 hidden md:flex">
          <a
            href="#home"
            className="relative hover:text-indigo-500 transition duration-300 after:absolute after:bottom-0 after:left-0 after:w-0 after:h-0.5 after:bg-indigo-600 after:transition-all after:duration-300 hover:after:w-full"
          >
            Home
          </a>
          <a
