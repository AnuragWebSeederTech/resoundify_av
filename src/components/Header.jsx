...
const Header = () => {
  ...
  return (
    <header className="w-full absolute top-0 left-0 right-0 bg-transparent z-50">
      {/* Top bar */}
      <div className="text-black bg-transparent text-base px-6 lg:px-10 py-1 mt-3 flex justify-between items-center">
        ...
        <div className="flex items-center space-x-6 font-medium tracking-wide">
          <div className="flex items-center space-x-2 hover:text-white transition duration-300 cursor-pointer">
