...
const ProductsHero = () => {
  return (
    <section 
      className="relative text-white h-[65vh] py-55 px-6 lg:px-16 overflow-hidden shadow-lg bg-cover bg-center"
      style={{ backgroundImage: `url('/images/productHero.png')` }} // Placeholder image path
    >
      <div className="absolute inset-0 bg-black opacity-30"></div> 

      <div className="relative z-10 text-center max-w-4xl mx-auto">
        <h1 className="text-5xl md:text-7xl text-black font-medium mb-6 leading-tight tracking-tighter">
