...
const ProductFilter = ({ categories, activeCategory, setActiveCategory }) => {
  ...
  }, [menuRef]); // Re-run effect if menuRef changes (though it won't in this case)
  ...
  return (
    ...
    <div className="mb-12 px-4 font-[Exo_2]">
      ...
      <div className="hidden md:flex flex-wrap justify-center gap-4 py-3 bg-white rounded-full shadow-lg max-w-260 mx-auto">
