...
const WeCraftedCard = ({ title, description, goal, stat, logo }) => {
  ...
  // Custom styles for fonts based on user's preference
  const primaryFont = { fontFamily: "'Exo 2', sans-serif" };
  const headingFont = { fontFamily: "'Tilt Neon', sans-serif" };
  ...
  return (
    <motion.div
      ...
      style={{ overflow: "hidden", ...primaryFont }} // Apply primary font to the whole card
    >
        ...
        <div className="flex md:flex-col items-center justify-between md:py-0 py-5 md:h-full max-w-full">
          <div>
            ...
            <h2
              ...
              style={headingFont} // Apply heading font
            >
              {title}
            </h2>
          </div>
